        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#f84704] hover:bg-[#d63d03] text-white font-bold px-6 py-3 rounded-lg transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg shadow-[#f84704]/30"
            >
              <svg
                className="w-5 h-5"
                fill="currentColor"
